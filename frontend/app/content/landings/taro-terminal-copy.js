...
export const TARO_TERMINAL_COPY = {
  ...
  states: [
    ...
    },
    {
      ...
      q2: {
        prompt: 'Что в этой карте похоже на твою ситуацию по ощущению? Где здесь ты, а где сама путаница?',
    ...
    },
    {
      ...
      q2: {
        prompt: 'Есть ли на карте намёк на маленькое движение вперёд?',
    ...
    },
    {
      ...
      q1: {
        prompt: 'Что в этой карте напоминает твою привязанность? Это боль, надежда, ожидание, незавершённость?',
